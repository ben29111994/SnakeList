...
namespace GPUInstancer
{
    public class GPUInstancerRuntimeData
    {
        ...
        public virtual void AddLodAndRenderer(Mesh mesh, List<Material> materials, MaterialPropertyBlock mpb, bool castShadows, float lodSize = -1, MaterialPropertyBlock shadowMPB = null, bool excludeBounds = false, int layer = 0)
        {
