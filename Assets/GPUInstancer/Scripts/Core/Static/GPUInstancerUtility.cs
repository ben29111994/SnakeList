...
namespace GPUInstancer
{
    public static class GPUInstancerUtility
    {
        ...
        public static ComputeBuffer MergeComputeBuffers(this ComputeBuffer computeBuffer, ComputeBuffer bufferToMerge, bool releaseMergedBuffers)
        {
            ...
            GPUInstancerConstants.computeBufferSetDataPartial.Dispatch(GPUInstancerConstants.computeBufferSetDataPartialKernelId, Mathf.CeilToInt(computeBuffer.count / GPUInstancerConstants.VISIBILITY_SHADER_THREAD_COUNT), 1, 1);
            ...
            GPUInstancerConstants.computeBufferSetDataPartial.Dispatch(GPUInstancerConstants.computeBufferSetDataPartialKernelId, Mathf.CeilToInt(bufferToMerge.count / GPUInstancerConstants.VISIBILITY_SHADER_THREAD_COUNT), 1, 1);
        ...
        public static void CopyTextureWithComputeShader(Texture source, Texture destination, int offsetX)
        {
            ...
            GPUInstancerConstants.computeTextureUtils.Dispatch(0, Mathf.CeilToInt(source.width / 8f), Mathf.CeilToInt(source.height / 8f), 1);
